...
//返回值:0,正常
//    其他,失败
u8 mpu_dmp_get_data(int *pitch,int *roll,int *yaw)
{
	...
	**/
	if(sensors&INV_WXYZ_QUAT) 
	{
		...
		q3 = quat[3] / q30; 
		//计算得到俯仰角/横滚角/航向角
		*pitch = (int)(10*asin(-2 * q1 * q3 + 2 * q0* q2)* 57.3);	// pitch
		*roll  = (int)(10*atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2* q2 + 1)* 57.3);	// roll
		*yaw   = (int)(10*atan2(2*(q1*q2 + q0*q3),q0*q0+q1*q1-q2*q2-q3*q3) * 57.3);	//yaw
	}else return 2;
	return 0;
}
